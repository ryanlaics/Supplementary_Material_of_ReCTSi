...
Followint the convention of SOTA works, ReCTSi is evaluated across various domains, including traffic, air quality, and COVID-19, exhibits SOTA accuracy and efficiency. Additionally, we have added the study of the impact of varying missing rates$^*$, which further affirms its robustness to diverse data conditions, including extremely sparse datasets. Thus, its underperformance on specific data characteristics cannot be conclusively concluded.
